...
scriptcmds = {
    ...
    ["xester"] =  function()
        CMSG(" > Running Xester V by tubers93")
    ...
    ["memeus 2"] =  function()
        CMSG(" > Running Memeus 2.0 by tubers93")
    ...
    ["hacker"] = function()
	    CMSG(" > Running Hacker X by tubers93")
    ...
    ["voodoo"] = function()
        CMSG(" > Running Voodoo Child by tubers93")
    ...
    ["cart"] = function()
	CMSG(" > Running Shopping Cart by tubers93")
